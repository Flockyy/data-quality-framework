...
from dqf.monitor import Alert, DataQualityMonitor, QualityMetrics
...
class TestQualityMetrics:
    def test_metrics_initialization(self):
        ...
        metrics = QualityMetrics(dataset_name="test", measured_at=datetime.now(), row_count=100)
...
class TestDataQualityMonitor:
    def test_monitor_initialization(self):
        ...
        monitor = DataQualityMonitor(enable_history=True, history_retention_days=90)
    ...
    def test_measure_quality(self, monitor, sample_dataframe):
        ...
        metrics = monitor.measure_quality(sample_dataframe, dataset_name="test_data")
    ...
    def test_timeliness_check(self, monitor):
        ...
        # Recent data
        df_fresh = pd.DataFrame({"timestamp": [datetime.now() - timedelta(hours=1)]})

        metrics_fresh = monitor.measure_quality(
            df_fresh, dataset_name="test", timestamp_column="timestamp", max_age_hours=24
        )
    ...
    def test_metrics_history(self, monitor, sample_dataframe):
        ...
        for i in range(3):
            monitor.measure_quality(sample_dataframe, dataset_name="test_data")
    ...
    def test_trend_detection(self, monitor, sample_dataframe):
        ...
        # First measurement
        metrics1 = monitor.measure_quality(sample_dataframe, dataset_name="test_data")
        ...
        # Second measurement
        metrics2 = monitor.measure_quality(df_degraded, dataset_name="test_data")
...
class TestHistoryManagement:
    def test_history_cleanup(self, monitor, sample_dataframe):
        ...
        old_metrics = QualityMetrics(
            dataset_name="test", measured_at=datetime.now() - timedelta(days=10), row_count=100
        )

        # Create recent metric
        recent_metrics = QualityMetrics(dataset_name="test", measured_at=datetime.now(), row_count=100)
    ...
    def test_get_metrics_history_with_days(self, monitor):
        ...
        for days_ago in [1, 5, 10, 20]:
            metrics = QualityMetrics(
                dataset_name="test", measured_at=datetime.now() - timedelta(days=days_ago), row_count=100
            )
