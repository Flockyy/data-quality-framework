...
data = {
    ...
    'customer_email': [f'customer{i}@example.com' if i % 20 != 0 else f'invalid_email_{i}' 
    ...
    'status': np.random.choice(['pending', 'confirmed', 'shipped', 'delivered', 'invalid'], 
                               500, p=[0.2, 0.3, 0.3, 0.15, 0.05]),
    'payment_method': np.random.choice(['credit_card', 'debit_card', 'paypal', None], 
                                      500, p=[0.4, 0.3, 0.25, 0.05]),
}
